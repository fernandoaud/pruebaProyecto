...
<div class="tabs-under">
  <c:if test="${isEvents}">
    <a href="Listing.action">Listado de Eventos</a>
    |<a href="New.action">Nuevo Evento</a>
  </c:if>
  <c:if test="${isPeople}">
    <a href="Listing.action">Listado de personas</a>
    |<a href="New.action">Nueva persona</a>
  </c:if>
  &nbsp;
</div>
